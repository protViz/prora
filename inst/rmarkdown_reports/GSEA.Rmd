...
* [The rankTable.rnk table used.](`r file.path("rankTable.rnk")`){target="_blank"}
...
Since `WebGestaltR` provides its own summary report, please refer to [WebGestalt result file](`r file.path(repfile)`){target="_blank"}.
