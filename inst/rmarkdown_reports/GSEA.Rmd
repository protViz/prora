...
DT::datatable(genesets, escape = FALSE, colnames = c("Pathway", "Description", "ES", "NES", "P-value","Adj. P-value"), style = "bootstrap") %>% DT::formatRound(digits = 3, columns = c("ES", "NES", "pValue", "FDR"))
```
