...
if (nrow(mainPathways) > 0) {
  ...
  mainPathways$pathway <-
    DT_makeURLfor(mainPathways$pathway, path = "https://www.gsea-msigdb.org/gsea/msigdb/cards/")
  
  mainPathways$leadingEdge <-
    lapply( mainPathways$leadingEdge, DT_makeURLfor, path = ="https://www.ncbi.nlm.nih.gov/gene/")
