...
Gene-sets defined in the Molecular Signature Database [MSigDB](http://www.gsea-msigdb.org/) were used (http://www.gsea-msigdb.org/).
To generate the analysis the following R packages have been used `r BiocStyle::Biocpkg("msigdbr")`, `r BiocStyle::Biocpkg("fgsea")` and `r BiocStyle::Githubpkg("protviz", "prora")`
